...
void main() async {
  ...
  // Initialize HabitDatabase statically first
  await HabitDatabase.init();

  // Create instance after initialization
  ...
  runApp(
    MultiProvider(
      providers: [
        ChangeNotifierProvider<HabitDatabase>.value(
          value: habitDatabase, // Use the initialized instance
        ),
